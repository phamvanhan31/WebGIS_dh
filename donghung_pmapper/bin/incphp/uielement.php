...
class UiElement
{
    ...
    */
    ...
    {
        $pmLogoUrl = array_key_exists('pmLogoUrl', $_SESSION) ? $_SESSION['pmLogoUrl'] : "http://donghung.thaibinh.gov.vn/Pages/Home.aspx";
        $pmLogoTitle = array_key_exists('pmLogoTitle', $_SESSION) ? $_SESSION['pmLogoTitle'] : "Sở Tài nguyên Môi trường Quảng Ninh";
        ...
        $pmHeading = array_key_exists('pmHeading', $_SESSION) ? $_SESSION['pmHeading'] : "<div style=\"color:#FFFF55\"> Hệ thống thông tin quy hoạch sử dụng đất huyện Đông Hưng, tỉnh Thái Bình</div>";
