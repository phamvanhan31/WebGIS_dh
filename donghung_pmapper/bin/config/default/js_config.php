...
//PM.scaleSelectList = ["100,000", "250,000", "500,000", "1,000,000", "2,500,000", "5,000,000", "10,000,000", "25,000,000"];
//PM.scaleSelectList = ["100'000", "250'000", "500'000", "1'000'000", "2'500'000", "5'000'000", "10'000'000", "25'000'000"];
PM.scaleSelectList = ["5 000", "10 000","15 000", "25 000", "50 000", "100 000", "250 000", "500 000"];
...
PM.buttonsDefault1 = {
    ...
    buttons: [
		...
		{tool:'digitizepolygon', name:'Digitize Polygon'},
		{tool:'binh_review_feedback', name: 'binh_review_feedback'},
//		{tool:'binh_dlg',   name:'binh_dlg'},		
    ]
};
